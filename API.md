...
- profileBackground: 사용자의 프로필 배경 사진 경로입니다. 256바이트 이하의 문자열입니다.
...
- 올바른 URL-safe base64 문자열이 아닌 경우.
- URL-safe base64를 디코드했을 때 24바이트가 아닌 경우.
...
요청한 사용자가 문제 생성 권한이 있는 경우, 주어진 문제를 새로 추가합니다.
...
요청한 사용자가 admin에 속하거나 해당 사용자 본인일 경우, 해당 사용자의 이메일을 변경합니다.
