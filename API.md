...
요청한 사용자가 문제 생성 및 편집 권한이 있는 경우, 주어진 문제를 새로 추가합니다. 이미 해당 문제가 존재한다면, 아무 일도 하지 않습니다. 문제 생성 및 편집 권한이 있다는 것은, 요청한 사용자가 admin이거나 사용자의 roles에 문제의 role이 포함되었다는 뜻입니다.
...
요청한 사용자가 편집 권한이 있는 경우, 해당 문제를 삭제합니다. 문제 생성 및 편집 권한이 있다는 것의 의미는 `PUT /problems` 와 동일합니다.
