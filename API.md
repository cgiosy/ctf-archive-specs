...
주어진 검색어가 포함된 대회들에 대해, 요청한 사용자가 해당 문제의 열람 권한이 있는 문제의 목록을 반환합니다.
...
- { count, contests }
  - count: 주어진 검색어가 포함된 대회의 개수입니다. sort 혹은 page에 영향을 받지 __않습니다__.
  - contests: 대회 정보들을 source를 기준으로 정렬했을 때, [25 * (page - 1), 25 * page) 구간 배열입니다. 대회 정보는 다음과 같은 객체입니다.
    - { source, problems }
      - source: 대회의 이름입니다.
      - problems: 해당 대회에 포함된 문제의 목록입니다. 문제 정보는 다음과 같은 객체입니다.
        - { id, levels, title, solves }
